...
export function MakePrediction() {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h1 className="text-2xl font-bold text-white sm:text-3xl">Make Prediction</h1>
        <p className="mt-2 text-slate-400">Enter loan applicant details and get live model prediction from Flask backend</p>
      </div>

      <div className="space-y-6">
        <div className="rounded-2xl border border-white/10 bg-slate-900/50 p-4 shadow-2xl backdrop-blur-xl sm:p-8">
          <h2 className="mb-5 text-lg font-semibold text-white sm:mb-6 sm:text-xl">Input Features</h2>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <button
              onClick={handlePredict}
              disabled={!isFormValid || loading}
              className="mt-3 flex h-10 w-full items-center justify-center gap-2 rounded-lg bg-gradient-to-r from-blue-500 to-purple-600 px-4 text-sm font-semibold text-white shadow-lg shadow-blue-500/50 transition-all hover:shadow-xl hover:shadow-blue-500/60 disabled:cursor-not-allowed disabled:opacity-50 disabled:shadow-none sm:col-span-2"
            >
              <Sparkles className="size-5" />
              {loading ? "Predicting..." : "Predict"}
            </button>
        ...
        <div className="rounded-2xl border border-white/10 bg-slate-900/50 p-4 shadow-2xl backdrop-blur-xl sm:p-8">
          <h2 className="mb-5 text-lg font-semibold text-white sm:mb-6 sm:text-xl">Prediction Result</h2>
